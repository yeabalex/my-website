    ...
    <ImagesSlider className="h-screen" images={images}>
      ...
      >
        ...
        <div className="flex justify-center space-x-4 mb-4">
          ...
          <a href="" target="_blank" rel="noopener noreferrer" className="text-white hover:text-emerald-300 transition-colors bg-black/30 rounded-full p-2">
...
//https://www.linkedin.com/in/yeabsira-alemu